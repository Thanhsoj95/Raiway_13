...
public class For {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 2; i++) {
			System.out.println("Thông tin department thứ " + (i + 1) + " là:");
			System.out.println("Id: " + numberofdepartment[i].id);
			System.out.println("Name: " + numberofdepartment[i].name);
			System.out.println("\n");
		}
		// Question 13:
		Account[] numberaccounts = { account1, account2, account3, account4, account5 };
		for (int i = 0; i < numberaccounts.length; i++) {
			if (i == 1) {
				continue;
			}
				System.out.println("Thông tin của account thứ " + (i + 1) + " là:");
				System.out.println("Id: " + numberaccounts[i].id);
				System.out.println("Email: " + numberaccounts[i].email);
				System.out.println("Username: " + numberaccounts[i].username);
				System.out.println("Full name: " + numberaccounts[i].fullname);
				System.out.println("Department " + numberaccounts[i].department.name);
				System.out.println("Position " + numberaccounts[i].position.name);
				System.out.println("\n");
		}
		// Question 14:
		Account[] countaccount = { account1, account2, account3, account4, account5 };
		for (int i = 0; i < countaccount.length; i++) {
			if (countaccount[i].id == 4) {
				break;
				}
				System.out.println("Thông tin của account thứ " + (i + 1) + " là:");
				System.out.println("Id: " + countaccount[i].id);
				System.out.println("Email: " + countaccount[i].email);
				System.out.println("Username: " + countaccount[i].username);
				System.out.println("Full name: " + countaccount[i].fullname);
				System.out.println("Department " + countaccount[i].department.name);
				System.out.println("Position " + countaccount[i].position.name);
				System.out.println("\n");
		}
