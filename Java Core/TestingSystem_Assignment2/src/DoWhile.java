...
public class DoWhile {
	...
	public static void main(String[] args) {
		...
		// Question 12:
		Department[] numberofdepartment = { department1, department2, department3, department4, department5 };
		int u = 0;
		do {
			if (u == 2) {
				break;
			...
			System.out.println("Id: " + numberofdepartment[u].id);
			System.out.println("Name: " + numberofdepartment[u].name);
			System.out.println("\n");
			u++;
		} while (u < numberofdepartment.length);
		
		// Question 13:
		Account[] numberaccounts = { account1, account2, account3, account4, account5 };
		int k = 0;
		do {
			if (k != 1) {
				System.out.println("Thông tin của account thứ " + (k + 1) + " là:");
				System.out.println("Id: " + numberaccounts[k].id);
				System.out.println("Email: " + numberaccounts[k].email);
				System.out.println("Username: " + numberaccounts[k].username);
				System.out.println("Full name: " + numberaccounts[k].fullname);
				System.out.println("Department " + numberaccounts[k].department.name);
				System.out.println("Position " + numberaccounts[k].position.name);
				System.out.println("\n");
			}
			k++;
		} while (k < numberaccounts.length);
		
		// Question 14:
		Account[] countaccount = { account1, account2, account3, account4, account5 };
		int h = 0;
		do {
			if (countaccount[h].id == 4) {
				break;
			}
			System.out.println("Thông tin của account thứ " + (h + 1) + " là:");
			System.out.println("Id: " + countaccount[h].id);
			System.out.println("Email: " + countaccount[h].email);
			System.out.println("Username: " + countaccount[h].username);
			System.out.println("Full name: " + countaccount[h].fullname);
			System.out.println("Department " + countaccount[h].department.name);
			System.out.println("Position " + countaccount[h].position.name);
			System.out.println("\n");
			h++;
		} while (h < countaccount.length);
