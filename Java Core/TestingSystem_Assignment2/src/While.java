...
public class While {
	...
	public static void main(String[] args) {
		...
		while (k < 2) {
			...
			System.out.println("Id: " + numberofdepartment[k].id);
			System.out.println("Name: " + numberofdepartment[k].name);
			System.out.println("\n");
			k++;
		}
		// Question 13:
		...
		int u = 0;
		while (u < numberaccounts.length) {
			if (u != 1) {
				System.out.println("Thông tin của account thứ " + (u + 1) + " là:");
				System.out.println("Id: " + numberaccounts[u].id);
				System.out.println("Email: " + numberaccounts[u].email);
				System.out.println("Username: " + numberaccounts[u].username);
				System.out.println("Full name: " + numberaccounts[u].fullname);
				System.out.println("Department " + numberaccounts[u].department.name);
				System.out.println("Position " + numberaccounts[u].position.name);
				System.out.println("\n");
				}
			u++;
		}
