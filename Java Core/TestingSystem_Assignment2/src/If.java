...
public class If {
	...
	public static void main(String[] args) {
		...
		if (account2.department == null) {
			...
			System.out.println("nhân viên này có phòng ban là " + account2.department.name);
		}
		// Question 2:
		...
		System.out.println(account2.department == null ? "nhân viên này chưa có phòng ban"
				: "nhân viên này có phòng ban là " + account2.department.name);

		// Question 4:
		System.out.println(
				account1.position.name == PositionName.DEV ? "Đây là Developer" : "Người này không phải Developer");
	}
}